...
const MODULES = {
  ...
  paths:       { mutate: 'src/config/paths.ts',               tests: 'test/paths.test.ts' },
  config:      { mutate: 'src/config/index.ts',               tests: 'test/config.test.ts' },
  formats:     { mutate: 'src/formats/*.ts',                  tests: 'test/formats.test.ts,test/cover.test.ts,test/head.test.ts' },
  ...
  watch:       { mutate: 'src/services/scanner/watch.ts',     tests: 'test/watch.test.ts' },
