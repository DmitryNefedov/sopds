...
const MODULES = {
  ...
  convert:     { mutate: 'src/services/convert/*.ts',         tests: 'test/convert.test.ts,test/convert-ir.test.ts,test/convert-zipwriter.test.ts,test/convert-fb2.test.ts,test/convert-epub.test.ts,test/convert-mobi.test.ts,test/convert-index-unit.test.ts' },
  'convert-ir':  { mutate: 'src/services/convert/ir.ts',       tests: 'test/convert-ir.test.ts,test/convert.test.ts' },
  'convert-zip': { mutate: 'src/services/convert/zipwriter.ts', tests: 'test/convert-zipwriter.test.ts,test/convert.test.ts' },
  'convert-fb2': { mutate: 'src/services/convert/fb2.ts',      tests: 'test/convert-fb2.test.ts,test/convert.test.ts' },
  'convert-epub': { mutate: 'src/services/convert/epub.ts',   tests: 'test/convert-epub.test.ts,test/convert.test.ts' },
  'convert-mobi': { mutate: 'src/services/convert/mobi.ts',   tests: 'test/convert-mobi.test.ts,test/convert.test.ts' },
  'convert-index': { mutate: 'src/services/convert/index.ts', tests: 'test/convert-index-unit.test.ts,test/convert.test.ts' },
  ...
  'routes-debug': { mutate: 'src/routes/debug.ts',  tests: 'test/routes.test.ts,test/debug-unit.test.ts' },
  'routes-app':   { mutate: 'src/app.ts',           tests: 'test/routes.test.ts,test/app-unit.test.ts' },
};
