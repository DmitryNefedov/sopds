...
const MODULES = {
  ...
  convert:     { mutate: 'src/services/convert/*.ts',         tests: 'test/convert.test.ts,test/convert-ir.test.ts,test/convert-zipwriter.test.ts,test/convert-fb2.test.ts,test/convert-epub.test.ts,test/convert-mobi.test.ts' },
